...
export const meta: MetaFunction = () => {
  return [
    { title: "Announcement Bar Pro" },
    { name: "description", content: "Create and manage promotional bars for your Shopify store." },
  ];
};
...
const FEATURES: {
  ...
  {
    icon: "⏱️",
    title: "Scheduling & countdowns",
    points: [
      "Set start and end dates/times for automated promotional campaigns.",
      "Live countdown timer with a custom message once expired.",
